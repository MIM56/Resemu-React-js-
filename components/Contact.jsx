        ...
        <div className="flex flex-col md:flex-row gap-8 shadow-xl shadow-blue-300 bg-white mt-4">
          <div className="w-full md:w-1/2 h-full rounded-xl p-4">
            ...
            <p className="pt-2 pb-8">
              Saya terbuka untuk berbicara tentang peluang lepas atau penuh
              waktu. Jangan ragu untuk menghubungi saya menggunakan media
              pilihan Anda.
            </p>

            <div className="grid grid-cols-2 mx-auto w-4/5 gap-10">
              <a
                href="https://www.instagram.com/mohamadirfan289/"
                target="_blank"
              >
              ...
              <a href="https://twitter.com/DNS_IRFAN56" target="_blank">
                <div className="flex items-center justify-center rounded-full shadow-md shadow-blue-500 hover:scale-105 duration-200 p-3 cursor-pointer">
                  <FaTwitter size={25} />
                </div>
              </a>
              <a
                href="https://www.facebook.com/irfan.rastafara.5458"
                target="_blank"
              >
                <div className="flex items-center justify-center rounded-full shadow-md shadow-blue-500 hover:scale-105 duration-200 p-3 cursor-pointer">
                  <FaFacebook size={25} />
              ...
              <a href="https://github.com/MIM56" target="_blank">
                <div className="flex items-center justify-center rounded-full shadow-md shadow-blue-500 hover:scale-105 duration-200 p-3 cursor-pointer">
                  <FaGithub size={25} />
                </div>
              </a>
